...
# CreateSuffixArray.with_tree is using Ukkonen’s Suffix Tree Construction
# due to speed optimizations, the suffix array created from the suffix tree
# returns additional element '@' which makes the tree explicit

describe 'suffix array test cases' do
  describe 'test cases 0' do
    let(:array_1) { [0] }
    it { expect(CreateSuffixArray.default('a')).to eq(array_1) }
    it { expect(CreateSuffixArray.with_tree('a')[1..-1]).to eq(array_1) }

    let(:array_2) { [0, 1] }
    it { expect(CreateSuffixArray.default('ab')).to eq(array_2) }
    it { expect(CreateSuffixArray.with_tree('ab')[1..-1]).to eq(array_2) }

    let(:array_3) { [0, 1, 2] }
    it { expect(CreateSuffixArray.default('abc')).to eq(array_3) }
    it { expect(CreateSuffixArray.with_tree('abc')[1..-1]).to eq(array_3) }

    let(:array_4) { [3, 0, 1, 2] }
    it { expect(CreateSuffixArray.default('abca')).to eq(array_4) }
    it { expect(CreateSuffixArray.with_tree('abca')[1..-1]).to eq(array_4) }
  end
  ...
  describe 'test case 1' do
    ...
    it { expect(CreateSuffixArray.with_tree('BANANA')[1..-1]).to eq(array) }
  end
  ...
  describe 'test case 2' do
    ...
    it { expect(CreateSuffixArray.with_tree('JACK')[1..-1]).to eq(array) }
  end
  ...
  describe 'test case 3' do
    ...
    it { expect(CreateSuffixArray.with_tree('DANIELS')[1..-1]).to eq(array) }
  end
  ...
  describe 'test case 5' do
    ...
    it { expect(CreateSuffixArray.with_tree('BOBOCEL')[1..-1]).to eq(array) }
  end
  ...
  describe 'test case 6' do
    ...
    it { expect(CreateSuffixArray.with_tree('ATTCATG')[1..-1]).to eq(array) }
  end
  ...
  describe 'test case 7' do
    ...
    it { expect(CreateSuffixArray.with_tree('CATTCAT')[1..-1]).to eq(array) }
  end
  ...
  describe 'test case 8' do
    ...
    it { expect(CreateSuffixArray.with_tree('DADDAD')[1..-1]).to eq(array) }
  end

  describe 'test case 9' do
    let(:array) { [0, 6, 3, 1, 7, 4, 2, 8, 9, 5] }
    it { expect(CreateSuffixArray.default('abcabxabcd')).to eq(array) }
    it { expect(CreateSuffixArray.with_tree('abcabxabcd')[1..-1]).to eq(array) }
  end
  ...
  describe 'test case 10' do
    ...
    it { expect(CreateSuffixArray.with_tree('DANIELSJACK')[1..-1]).to eq(array) }
  end
  ...
  describe 'test case 11' do
    ...
    it { expect(CreateSuffixArray.with_tree('YZYYZYYZYZYYZYZYY')[1..-1]).to eq(array) }
  end
end
